...
if __name__ == '__main__':
    ...
    train_dataset = DoAPredDataset("/data/ssharma497/beam_hw/radar_sim/", exps = ["Experiment_1", "Experiment_2", "Experiment_3"])
    test_dataset = DoAPredDataset("/data/ssharma497/beam_hw/radar_sim/", exps = ["Experiment_1", "Experiment_2", "Experiment_3"], train = False)
